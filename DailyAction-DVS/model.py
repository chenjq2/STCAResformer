...
class SpikingTokenizer(nn.Module):
    def __init__(self, img_size_h=128, img_size_w=128, patch_size=4, in_channels=2, embed_dims=512):
        ...
        # self.TCJA1 = Alayers.TCJA(4, 4, 16, embed_dims//8)
        ...
        # self.TCJA2 = Alayers.TCJA(4, 4, 16, embed_dims//4)
        ...
        self.TCJA3 = Alayers.TCJA(4, 4, 16, embed_dims//2)
        ...
        self.TCJA4 = Alayers.TCJA(4, 4, 16, embed_dims)
...
class vit_snn(nn.Module):
    def __init__(self,
                 img_size_h=128, img_size_w=128, patch_size=16, in_channels=2, num_classes=12,
...
def Spikingformer(pretrained=False, **kwargs):
    model = vit_snn(
        ...
        in_channels=2, num_classes=12, qkv_bias=False,
