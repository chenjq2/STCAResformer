...
def main(args):
    ...
    # sys.path.append("..")
    # # using real data
    # Nops, Nparams = get_model_complexity_info(model, (2, 128, 128), data_loader_test, as_strings=True,
    ...
    sys.path.append("..") 
    # using real data
    Nops, Nparams = get_model_complexity_info(model, (3, 128, 128), data_loader_test, as_strings=True,
                                              print_per_layer_stat=True, verbose=True, syops_units='Mac',
                                              param_units=' ', output_precision=3)
    # using random input
    # Nops, Nparams = get_model_complexity_info(model, (3, 224, 224), dataloader=None, as_strings=True, print_per_layer_stat=True, verbose=True, syops_units='Mac', param_units=' ', output_precision=3)
